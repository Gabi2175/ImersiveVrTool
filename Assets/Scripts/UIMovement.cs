...
// FONTE: https://github.com/OSVR/Unity-VR-Samples/blob/master/Assets/VRSampleScenes/Scripts/Utils/UIMovement.cs
...
public class UIMovement : MonoBehaviour
{
    ...
    [SerializeField] private float m_DistanceFromCamera = 1;                     // The distance the UI should stay from the camera when rotating with it.
    ...
    private void Update()
    {
        ...
        m_UIElement.position = new Vector3(m_UIElement.position.x, m_Camera.position.y, m_UIElement.position.z);
    }
}